...
public class HubCompanyRetrieveByIdStrategy implements CompanyRetrieveByIdStrategy {
    private final CompanyRepo companyRepo;

    @Override
    public CompanyResponse retrieveCompanyById(Long id, Long currentUser, Role role) {
        Company company = companyRepo.findByIdAndOwnerIdAndIsDeletedFalse(id, currentUser)
